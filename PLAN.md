...
4. **Service Contracts** – Generated protobuf modules (`meshmind/protos/memory_service.proto`) now back the Python stub. Next:
   expose a production-ready gRPC server, publish generated clients, and add integration tests once infrastructure is ready.
