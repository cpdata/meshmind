...
- `meshmind/tests/test_retrieval.py` and `test_graph_retrieval.py`: exercise hybrid, textual, vector, and graph-based
  searches.
- `meshmind/tests/test_service_interfaces.py`: cover REST and gRPC stubs including the new entity-label filtering.
- `meshmind/tests/test_cli_admin.py`: verify administrative CLI commands use the correct driver factory and settings.
