...
- [ ] Document Neo4j driver requirements and verify connectivity against a live cluster.
...
- [ ] Implement graph-backed retrieval queries leveraging Memgraph/Neo4j search capabilities once available.
