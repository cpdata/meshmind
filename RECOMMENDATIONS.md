...
- Propagate the new `llm_client` overrides through REST/gRPC surfaces and integration smoke tests so services honour per-request models/endpoints, not just the CLI and in-process client.
