...
from meshmind.testing import FakeLLMClient, FakeMemgraphDriver, FakeRedisBroker
...
@pytest.fixture
def memory_service(memory_manager, fake_llm_client):
    return MemoryService(memory_manager, llm_client=fake_llm_client)
