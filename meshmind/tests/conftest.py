...
try:  # pragma: no cover - allow test suite to skip when dependencies are unavailable
    import pydantic  # noqa: F401
except ModuleNotFoundError:  # pragma: no cover
    pytest.skip("pydantic is required for the MeshMind test suite", allow_module_level=True)
