...
class Settings:
    ...
    MAINTENANCE_MAX_ATTEMPTS: int = int(os.getenv("MAINTENANCE_MAX_ATTEMPTS", "3"))
    MAINTENANCE_BASE_DELAY_SECONDS: float = float(
        os.getenv("MAINTENANCE_BASE_DELAY_SECONDS", "1.0")
    )
    ...
    def summary(self) -> dict[str, str]:
        ...
        return {
            ...
            "MAINTENANCE_MAX_ATTEMPTS": self.MAINTENANCE_MAX_ATTEMPTS,
            "MAINTENANCE_BASE_DELAY_SECONDS": self.MAINTENANCE_BASE_DELAY_SECONDS,
        }
