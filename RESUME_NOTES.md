...
- Created `DUMMIES.md` to inventory compatibility shims, REST/gRPC stubs, Celery fallbacks, and fake drivers, and linked it
  from `README.md`, `SOT.md`, `PLAN.md`, `RECOMMENDATIONS.md`, `PROJECT.md`, and `FINDINGS.md` for future cleanup tracking.
