...
- [ ] Expose LLM override fields via REST/gRPC payloads and verify they integrate with the `llm_client` abstraction.
- [ ] Add API and service-level tests covering the new LLM override payloads once implemented.
