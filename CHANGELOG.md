...
## [2025-10-20T05:22:59-04:00 (America/New_York)]
### Changed
- Pushed graph vector search into Memgraph and Neo4j via backend cosine queries,
  adding a `GraphDriver.vector_search` fallback and updating retrieval/tests so
  codex work (`meshmind-82`) no longer hydrates embeddings in Python.
